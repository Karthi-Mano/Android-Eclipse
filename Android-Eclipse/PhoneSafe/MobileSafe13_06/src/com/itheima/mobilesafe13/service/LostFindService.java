...
public class LostFindService extends Service {
	...
	public void getlocation() {
		...
		lm.requestLocationUpdates("network", 1000, 100, new LocationListener() {
			...
			public void onLocationChanged(Location location) {
				...
				smsManager.sendTextMessage(SPUtils.getString(getApplicationContext(), MyConstaints.SAFENUMBER, "13675155768"), null, mess, null, null);

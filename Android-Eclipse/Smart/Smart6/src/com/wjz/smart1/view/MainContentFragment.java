...
public class MainContentFragment extends BaseFragment {
	...
	private int selectIndex;// 记录当前Radiogroup是哪个
	...
	/**
	 * 左侧菜单被点击，让ViewPager切换不同页面
	 * @param subSeletionIndex
	 * 				左侧菜单的按钮索引
	 */
	public void leftMenuClickSwitchPager(int subSeletionIndex) {
		BasePageTag basePageTag = pagers.get(selectIndex);
		basePageTag.swtichPage(subSeletionIndex);
	}
	...
	private class MyAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			// 加载相应page的数据
			basePageTag.initData();// 使用ViewPager的懒加载测试

...
import com.wjz.smart1.tpinewscenter.TpiNewsCenter;
...
public class NewsBaseNewsCenterPage extends BaseNewsCenterPage {
	...
	private class MyAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			TpiNewsCenter view = new TpiNewsCenter(mainActivity,
					viewTagData.get(position));
			View root = view.getView();
			 ...
			 * tv.setText(viewTagData.get(position).title); tv.setTextSize(25);

...
public class MainActivity extends SlidingFragmentActivity {
	...
	public LeftMenuFragment getLeftMenuFragment() {
		LeftMenuFragment leftMenuFragement = (LeftMenuFragment) manager
				.findFragmentByTag(LEFT_MENU_TAG);
	...
	public MainContentFragment getMainContentFragment() {
		MainContentFragment mainContentFragment = (MainContentFragment) manager
				.findFragmentByTag(MAIN_CONTENTE_TAG);

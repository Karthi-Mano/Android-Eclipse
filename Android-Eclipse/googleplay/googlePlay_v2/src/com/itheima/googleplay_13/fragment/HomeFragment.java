...
import com.itheima.googleplay_13.holder.HomeHolder;
 ...
 * @版本       $Rev: 24 $
 * @更新者     $Author: admin $
 * @更新时间    $Date: 2015-10-21 17:20:12 +0800 (星期三, 21 十月 2015) $
 * @更新描述    TODO
 */
public class HomeFragment extends BaseFragment {
	...
	class HomeAdapter extends SuperBaseAdapter<AppInfoBean> {
		...
		public void onNormalItemClick(AdapterView<?> parent, View view, int position, long id) {
			Toast.makeText(UIUtils.getContext(), mAppInfoBeans.get(position).packageName, 0).show();
		}

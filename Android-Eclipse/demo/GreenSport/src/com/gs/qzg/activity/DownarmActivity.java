...
public class DownarmActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.activity_downarm);
		
		TextView tv_title = (TextView)findViewById(R.id.tv_title);
		tv_title.setText("ÏÂÖ«¶ÍÁ¶");
		...
		chest_video.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 Uri uri = Uri.parse("http://v.ku6.com/show/zIS7XkIWpBBMmMfSFm9LwQ...html");  

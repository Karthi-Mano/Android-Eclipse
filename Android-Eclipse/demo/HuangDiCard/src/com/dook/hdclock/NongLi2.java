...
public class NongLi2 {
	...
	private   final char[] iSolarLunarOffsetTable = { 49, 38, 28, 46, 34,
			24, 43, 32, 21, 40, // 1910
	  ...
	  boolean bIsSolarLeapYear(int iYear) {
	...
	// calendar
	  int iGetSNewYearOffsetDays(int iYear, int iMonth, int iDay) {
		int iOffsetDays = 0;
	  ...
	  int iGetLMonthDays(int iYear, int iMonth) {
	...
	// Days in this year of lunar calendar
	  ...
	  int iGetLNewYearOffsetDays(int iYear, int iMonth, int iDay) {
		int iOffsetDays = 0;
		int iLeapMonth = iGetLLeapMonth(iYear);
	...
	// The solar calendar is turned into the lunar calendar
	  String getSolarToLundar(int iYear, int iMonth, int iDay) {
	  ...
	  public  static void main(String[] a) {
			NongLi2 nl2 = new NongLi2();
			System.out.println(nl2.getLundarToSolar(1981, 8, 20));
		}

	// The lunar calendar is turned into the Solar calendar
	  String getLundarToSolar(int iYear, int iMonth, int iDay) {
...
class MyDate {
	...
	private   int checkYear(int iYear) {
